...
class PushAndPickStateMachine {
 public:
  ...
  /// Construct a push and pick state machine.  If @p loop
  /// is true, the state machine will loop through the push and pick task, otherwise it will remain in the kDone state once
  /// complete.
