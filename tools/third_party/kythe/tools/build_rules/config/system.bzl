...
load("@drake//tools/third_party/kythe/tools/build_rules/config:wrapped_ctx.bzl", "wrapctx")
load("@drake//tools/third_party/kythe/tools/build_rules/config:local.bzl", "setup_local_cc_library")
load("@drake//tools/third_party/kythe/tools/build_rules/config:pkg_config.bzl", "setup_pkg_config_package")
...
cc_system_package_configure = repository_rule(
    ...
    attrs = {
        ...
        "build_file_template": attr.label(
            default = Label("@drake//tools/third_party/kythe/tools/build_rules/config:BUILD.tpl"),
            single_file = True,
            allow_files = True,
        ),
    },
