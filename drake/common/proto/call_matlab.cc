...
void internal::ToMatlabArrayImpl(const Eigen::Ref<const Eigen::MatrixXd>& mat,
...
void internal::ToMatlabArrayImpl(const Eigen::Ref<const Eigen::MatrixXi>& mat,
                       MatlabArray* matlab_array, bool is_vector) {
  matlab_array->set_type(MatlabArray::INT);
  matlab_array->set_shape_type(
      is_vector ? MatlabArray::VECTOR : MatlabArray::MATRIX);
...
void internal::ToMatlabArrayImpl(
