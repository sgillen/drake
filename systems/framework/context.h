...
class Context : public ContextBase {
 public:
  ...
  /// the given vector @p vec. Asserts if @p index is out of range.
  ...
  FreestandingInputPortValue& FixInputPort(
    ...
    SetInputPortValue(InputPortIndex(index), std::move(freestanding));
  ...
  /// Connects the input port at @p index to a FreestandingInputPortValue with
  /// the given abstract @p value. Asserts if @p index is out of range. See
  /// the BasicVector signature above for more information.
  FreestandingInputPortValue& FixInputPort(
