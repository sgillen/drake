...

  {
    ...
    py::class_<Class>(m, "InverseKinematics", cls_doc.doc)
        ...
        .def("AddAngleBetweenVectorsConstraint",
            &Class::AddAngleBetweenVectorsConstraint,
