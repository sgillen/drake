...
class MultibodyPlant : public MultibodyTreeSystem<T> {
 ...
 private:
  ...
  // Helper to check when a deprecated `scene_graph` pointer is passed in.
  // @pre Must be already registred with scene graph.
  void CheckSceneGraph(const geometry::SceneGraph<T>* scene_graph) const;
