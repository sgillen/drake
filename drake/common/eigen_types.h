...
/// A matrix of N rows, dynamic columns, templated on scalar type.
template <int N, typename Scalar>
using MatrixNX = Eigen::Matrix<Scalar, N, Eigen::Dynamic>;

/// A vector of N rows, templated on scalar type.
template <int N, typename Scalar>
