...
Experimental configuration for vtk, until there is a better mechanism to build VTK under Bazel.

See also: https://github.com/RobotLocomotion/drake/compare/master...jwnimmer-tri:bazel-vtk
...
In your ~/.bash_aliases, use VTK_ROOT and VTK_VERSION and export these:
...
NOTE: You may copy+paste/include :vtk_env.sh.
"""
