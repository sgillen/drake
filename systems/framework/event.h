...
class EventHandlerStatus {
 public:
  ...
  static EventHandlerStatus ReachedTermination(const SystemBase* system,
                                               std::string message) {
    return EventHandlerStatus(kReachedTermination, system, message);
  }

  /// Sets this status to "failed" with a message explaining why.
  static EventHandlerStatus Failed(const SystemBase* system,
                                   std::string message) {
    return EventHandlerStatus(kFailed, system, message);
  }
 ...
 private:
  ...
  EventHandlerStatus(Severity severity, const SystemBase* system,
                     std::string message)
